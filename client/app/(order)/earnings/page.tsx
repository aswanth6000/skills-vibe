    ...
    <div className="p-8 bg-white text-bodydark2">
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-green-100 p-4 rounded-md">
            <p className="text-xl font-bold mb-2">Balance available for use</p>
            <p>$3.95</p>
          </div>
          <div className="bg-green-100 p-4 rounded-md">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-green-100 p-4 rounded-md">
            <p className="text-xl font-bold mb-2">Payments for active orders</p>
            <p>Coming soon</p>
          </div>
        </div>
      </section>
...
<tbody>
  {data.map((item) => (
    <tr key={item._id}>
      ...
      <td className="border-2 text-green-700 font-bold">${item.gigPrice}</td>
    </tr>
  ))}
</tbody>
